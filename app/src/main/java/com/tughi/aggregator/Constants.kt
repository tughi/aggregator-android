...
const val FEED_JOB__MULTIPLIER = 10
const val FEED_JOB__INCREMENT__FAVICON_UPDATER = 1

const val NOTIFICATION_CHANNEL__MY_FEED = "my_feed"
const val NOTIFICATION__NEW_ENTRIES__MY_FEED = 1
